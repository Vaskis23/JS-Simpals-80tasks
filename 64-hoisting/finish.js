...
/**
 * ошибка "ReferenceError: Cannot access 'c' before initialization" к переменной обращаются до ее объявления внутри блока if и снаружи..
 * объявляем переменную перед использованием и внутри блока if.
