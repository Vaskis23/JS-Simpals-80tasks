 ...
 * При вызове метода customPush новый элемент newElement добавляется в существующий массив this путем присваивания по индексу this.length.
...
//вопрос
//Каким образом работает метод customPush() в классе CustomArray?
