...
//вопрос
//Как работает деструктуризация массивов в этой строке 17?

//Деструктуризация массивов позволяет извлечь элементы массива и присвоить их переменным с помощью синтаксиса [min, max]. 
//В данном случае, значения, возвращаемые функцией minMax, будут разбиты на две переменные min и max