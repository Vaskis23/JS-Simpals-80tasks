 ...
 * [minQty, maxQty, defaultQty = 0] - означает, что первый элемент массива будет присвоен переменной minQty, второй элемент - переменной maxQty, третий элемент - переменной defaultQty. 
