...
/**
 * В решении задачи с использованием параметра функции по умолчанию определяем функцию "weatherForecast" с двумя параметрами. 
 * Параметр "weather" имеет значение по умолчанию, указанное после знака "=".
 * вызваем функцию "weatherForecast" с разными комбинациями аргументов:
 * вызывая функцию "weatherForecast", передаем значение для параметра "city" и, при необходимости, значение для параметра "weather". 
 * Если значение для "weather" не указано, функция будет использовать значение по умолчанию "Отличная погода!".
 */

//вопрос 
// возможны примвоить любые показания параметра для функции по умолчанию? число, булеан? и только строка?