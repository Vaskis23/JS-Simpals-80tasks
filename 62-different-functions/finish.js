...
//Вопрос
//Разница между объявлением функции с помощью ключевого слова function и объявлением функции через присваивание значения переменной заключается в способе их создания?
